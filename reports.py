    ...
    def generate_inventory_report(self):
        ...
        try:
            ...
            for row_idx, product in enumerate(products):
                ...
                # Unpack all 8 values from the query result
                product_id, name, category, unit_price, cost_price, stock, expiry, is_active = product
                ...
                if not is_active:  # Changed from product[7] to is_active
